...
#endif
static const char *ng0 = "D:/coding/CO/Verilog/P6/mem_wb.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {2, 0};
...
LAB47:    if (*((unsigned int *)t411) != 0)
        goto LAB48;

LAB49:    t418 = (t4 + 4);
    t419 = *((unsigned int *)t4);
    t420 = *((unsigned int *)t418);
    t421 = (t419 || t420);
    if (t421 > 0)
        goto LAB50;

LAB51:    t423 = *((unsigned int *)t4);
    t424 = (~(t423));
...
LAB53:    if (*((unsigned int *)t418) > 0)
        goto LAB54;

LAB55:    if (*((unsigned int *)t4) > 0)
        goto LAB56;

LAB57:    memcpy(t3, t427, 8);
...
LAB54:    xsi_vlog_unsigned_bit_combine(t3, 32, t422, 32, t427, 32);
    goto LAB58;

LAB56:    memcpy(t3, t422, 8);
    goto LAB58;

}


extern void work_m_00000000000748666437_1586474674_init()
{
	static char *pe[] = {(void *)Initial_35_0,(void *)Always_41_1,(void *)Cont_109_2,(void *)Cont_114_3};
	xsi_register_didat("work_m_00000000000748666437_1586474674", "isim/tb_isim_beh.exe.sim/work/m_00000000000748666437_1586474674.didat");
